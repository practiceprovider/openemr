...
<frameset rows="<?php echo "$GLOBALS[logoBarHeight],$GLOBALS[titleBarHeight]" ?>,50%,50%" cols="*" frameborder="NO" border="0" framespacing="0">
  ...
  <frame src="patient_select.php?patient=<?php echo $import;?>" name="Comment" scrolling="auto" noresize frameborder="NO">
  <frame src="keyboard.php?patient=<?php echo $import;?>" name="Authorization" scrolling="auto" frameborder="NO">	
