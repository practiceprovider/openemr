...
<span class='title title-background'><?php echo xlt('Patient Flow Board'); ?> - <?php echo xlt('Drug Screen Report'); ?></span>
<?php } else { ?>
    <span class='title title-background'><?php echo xlt('Patient Flow Board Report'); ?></span>
<?php } ?>
