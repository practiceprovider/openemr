...
<p class='title title-background'><b><?php echo xlt('Patient Flow Board'); ?> - <?php echo xlt('Drug Screen Report'); ?></b></p>
<?php } else { ?>
    <p class='title title-background'><b><?php echo xlt('Patient Flow Board Report'); ?></b></p>
<?php } ?>
